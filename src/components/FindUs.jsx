...
const FindUs = () => {
  ...
  return (
    ...
    <div>
      <div>
      <h1 id="HittaOss" className='mt-6 mb-2 text-yellow-500 font-bold text-4xl text-center'>
    Hitta Oss
  </h1>
    ...
    <div className="rounded overflow-hidden">
      ...
      <h1 id="OpenTider" className='mt-6 mb-2 text-yellow-500 font-bold text-4xl text-center'>
    Öppen Tider
  </h1>
        <ul className="mt-10 text-gray text-base space-y-6">
         <li><b>Vardag:</b> 10:30 - 21:00</li>
         <li><b>Helg:</b> 11:00 - 21:00</li>
         <li><b>Lunch:</b> 10:30 - 15:00</li>

         <li><b>Adress:</b> Kunsgatan 102, 903 32 Umeå</li>
