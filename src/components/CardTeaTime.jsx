...
<div class="rounded overflow-hidden">
  <div class="px-6 py-4 text-center">
    ...
    <div class="text-primary font-bold text-3xl mb-2">Stay purrly hydrated!</div>
...
Listen to your body and mind and adapt your eating after it.
...
<div class="rounded overflow-hidden">
  <div class="px-6 py-4 text-center">
    <div class="text-5xl mb-5">🍫</div>
    <div class="text-primary font-bold text-3xl mb-2">Feline sassy!</div>
    <p class="text-gray text-base">
